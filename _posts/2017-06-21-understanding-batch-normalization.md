...
This idea of your data distribution changing is known as $$\b Covariate shift $$. The idea is that if you've learned some X to Y mapping $$ X \rightarrow Y $$, if at any time the distribution of $$ X $$ changes, then you might need to retrain your learning algorithm.
